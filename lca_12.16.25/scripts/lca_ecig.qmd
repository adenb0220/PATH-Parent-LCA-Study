...
ecig <- read_csv(here("data", "selected_df_ecig_3.csv"))
...
plot_lca_function(
  ...
  item_labels = c("Lenient Rules (E-Cig)","Parental Use (E-Cig)",
                  ...
                  "Parental Use (Burned)"),
  class_labels = c( "E-Cig Favorable", "Lenient Rules", "Consistently Strict",
                   "Strict but Use Burned"),
  class_legend_order = c(3,2,4,1),

...
cbbPalette <- c("#40B0A6",  "#994F00", "#FFC20A","#0C7BDC")

smokeless <- read_csv(here("data", "selected_df_smokeless_4.csv"))
...
plot_lca_function(
  ...
  item_labels = c("Lenient Rules (Smokeless)","Parental Use (Smokeless)",
                  ...
                  "Parental Use (Burned)"),
  class_labels = c("Smokeless Favorable", "Lenient Rules",
                    "Consistently Strict", "Strict but Use Burned"),
  class_legend_order = c(3,4,2,1),
...
ggsave(here("figures","c4_smokeless_plot.JPEG"),    
